     ...
     <div>
         <div class="container">
                <div v-if="(cartItems.length > 0)" class="row">
                    ...
                    <div  v-for="(cartItem, index) in cartItems" :key="cartItem.lesson._id" class="col-md-4" style="margin-bottom: 20px;">
                        <div class="col-md-12 check-out-1" >
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img v-bind:src="`/images/${cartItem.lesson.image}`" alt="" style="width: 100px; height: 100px; margin-top: 20px">
                                </div>
                            </div>
